...
def calculate_stats(start_time: float, end_time: float, 
...
def main():
    ...
    try:
        ...
        stats = calculate_stats(start_time, end_time, prompt_tokens, completion_tokens)
        ...
        print(f"  输入Token数: {stats['prompt_tokens']}")
        print(f"  输出Token数: {stats['completion_tokens']}")
        print(f"  总Token数: {stats['total_tokens']}")
        print(f"  处理速度: {stats['tokens_per_second']} tokens/s")
